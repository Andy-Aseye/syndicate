...
export default function NewEngagementForm() {
  ...
  return (
    <form action={createEngagement} className="space-y-6">
      <div>
        <label className="block text-sm font-bold text-gold uppercase tracking-wider mb-2">
          Client name *
        </label>
        <input
          name="clientName"
          required
          className="w-full px-4 py-3 rounded bg-card border border-white/10 focus:border-cyan outline-none"
      ...
      <div>
        ...
        <textarea
          name="brief"
          rows={8}
          className="w-full px-4 py-3 rounded bg-card border border-white/10 focus:border-cyan outline-none resize-none"
      ...
      <div className="flex gap-3 pt-4">
        <button
          type="submit"
          disabled={isPending}
          className="px-6 py-3 rounded bg-cyan text-bg font-bold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
