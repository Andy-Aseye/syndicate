...
| 2:45 – 3:00 | **Close** | End card: GitHub URL + hosted dashboard URL + architecture diagram. | *"Six ADK agents. A2A between them. Lighthouse QA on the dashboard. All deployed on Cloud Run. Repo and live URL are in the description."* |
